...
def make_cdf(sp, depth=None, units_only=False, laterality=False) -> None:
    ...
    spike_depths, spike_amps, spike_x = get_temp_pos(sp, depth)
...
def get_temp_pos(sp: dict, depth=None) -> tuple[np.array, np.array, np.array]:
